...
ProgressBar.prototype.timeRemaining = function () {
	var ticksPerSec = this.opsPerSec,
...
function secondsToMin(sec) {
	var totalTimeHr  = Math.floor(sec / (60 * 60)),
		totalTimeMin = Math.floor((sec - (totalTimeHr * 60 * 60)) / 60),
		totalTimeSec = Math.floor(sec - (totalTimeMin * 60) - (totalTimeHr * 60 * 60));
